...
app.get('/', function(req, resp) {
  resp.render('splash', { "isMobile" : isCallerMobile(req)});
});

app.get('/the-wedding-party', function(req, resp) {
  resp.render('the-wedding-party', { "isMobile" : isCallerMobile(req)})
})

app.get('/wedding-details', function(req, resp) {
  resp.render('wedding-details', { "isMobile" : isCallerMobile(req)})
})

app.get('/gift-registry', function(req, resp) {
  resp.render('gift-registry', { "isMobile" : isCallerMobile(req)})
})

app.get('/local-attractions', function(req, resp) {
  resp.render('local-attractions', { "isMobile" : isCallerMobile(req)})
})
