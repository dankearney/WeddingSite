...
app.get('/', function(req, resp) {
  renderMobileFriendly(req, resp, 'splash');
});

app.get('/the-wedding-party', function(req, resp) {
  renderMobileFriendly(req, resp, 'the-wedding-party');
})

app.get('/wedding-details', function(req, resp) {
  renderMobileFriendly(req, resp, 'wedding-details');
})
...
function renderMobileFriendly(req, resp, target) {
  resp.render(target, { "isMobile" : isCallerMobile(req) });
}
...
function isCallerMobile(req, callback) {
